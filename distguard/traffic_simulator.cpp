...
std::vector<Packet> TrafficSimulator::generateTraffic(int count)
{
    ...
    if (count > 10)
    {
        ...
        for (int port = 1; port <= 100; port++)
        {
            ...
            std::cout << scan_pkt.serialize() << std::endl;
        }
    }
    ...
    for (int i = 0; i < count; ++i)
    {
        ...
        if (i % 50 == 0)
        {
            ...
            for (int j = 0; j < 20; j++)
            {
                ...
                std::cout << dos_pkt.serialize() << std::endl;
            }
        }
    }
    ...
    if (count > 20)
    {
        ...
        for (int i = 0; i < 100; i++)
        {
            ...
            std::cout << syn_pkt.serialize() << std::endl;
        }
    }
    ...
    if (count > 20)
    {
        ...
        for (int i = 0; i < 150; i++)
        {
            ...
            std::cout << ack_pkt.serialize() << std::endl;
        }
    }
    ...
    if (count > 30)
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            std::cout << replay_pkt.serialize() << std::endl;
        }
    }
    ...
    if (count > 15)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            std::cout << normal_pkt.serialize() << std::endl;
        }
        ...
        for (int i = 0; i < 25; i++)
        {
            ...
            std::cout << spoofed_pkt.serialize() << std::endl;
        }
    }
